...
def responder_con_gemini(user_text: str, from_number: str, session: dict) -> Optional[str]:
    """Genera una respuesta breve con Gemini cuando no hay match en el flujo deterministico."""
    ...
    try:
        prompt = (
            "Sos el asistente virtual de Cursala por WhatsApp. "
            "Responde en espanol rioplatense, en un maximo de 3 lineas, "
            "con tono claro y cordial. "
            "Si piden informacion comercial o de cursos y no estas seguro, "
            "invita a volver al menu escribiendo MENU o a hablar con un asesor (opcion 4). "
            "No inventes precios, fechas, links ni datos no confirmados.\n\n"
